                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li class="collapsed">
                        <a class="m-link active" data-bs-toggle="collapse" data-bs-target="#menu-report" href="#">
                            <i class="icofont-chart-pie fs-5"></i><span>Tous les Développeurs</span><span class="arrow icofont-rounded-down ms-auto text-end fs-5"></span>
                        </a>
                        <!-- Menu: Sub menu ul -->
                        <ul class="sub-menu collapse show" id="menu-report">
                            <li>
                                <router-link class="ms-link" to="/listedevloppeur">Développeur</router-link>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="form">
                            <li>
                                <router-link class="ms-link" to="/listedemestache">Mes tâches</router-link>
                            </li>
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="font">
                            <li>
                                <router-link class="ms-link" to="/tacheEncouruser">Tâches en cours</router-link>
                            </li>
                            <li>
                                <router-link class="ms-link" to="/tachetermineruser">Tâches terminées</router-link>
                            </li>
                        </ul>
                    </li>
                </ul>
                    ...
                    <div class="container-xxl">
                                                ...
                                                <ul class="list-unstyled list mb-0">
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            ...
                                                            <div class="flex-fill ms-2">
                                                                ...
                                                                <span class="">Added New Task 2021-07-15
                                                                    <span class="badge bg-success">Add</span></span>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            ...
                                                            <div class="flex-fill ms-2">
                                                                <p class="d-flex justify-content-between mb-0">
                                                                    <span class="font-weight-bold">Alan Hill</span>
                                                                    <small>13MIN</small>
                                                                </p>
                                                    ...
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            ...
                                                            <div class="flex-fill ms-2">
                                                                <p class="d-flex justify-content-between mb-0">
                                                                    <span class="font-weight-bold">Melanie Oliver</span>
                                                                    <small>1HR</small>
                                                                </p>
                                                                <span class="">Low Activity</span>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            ...
                                                            <div class="flex-fill ms-2">
                                                                <p class="d-flex justify-content-between mb-0">
                                                                    <span class="font-weight-bold">Boris Hart</span>
                                                                    <small>13MIN</small>
                                                                </p>
                                                                <span class="">New Task Toyseller</span>
                                                            </div>
                                                        </a>
                                                    </li>
                                                    <li class="py-2 mb-1 border-bottom">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            ...
                                                            <div class="flex-fill ms-2">
                                                                <p class="d-flex justify-content-between mb-0">
                                                                    <span class="font-weight-bold">Alan Lambert</span>
                                                                    <small>1HR</small>
                                                                </p>
                                                    ...
                                                    <li class="py-2">
                                                        <a href="javascript:void(0);" class="d-flex">
                                                            ...
                                                            <div class="flex-fill ms-2">
                                                                ...
                                                                <span class="">Profile Updated</span>
                                                            </div>
                                                        </a>
                                                    </li>
                                                </ul>
                            ...
                            <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center">
                                ...
                                <div class="card border-0 w280">
                                    ...
                                    <div class="list-group m-2">
                                        ...
                                        <a href="tracker-setting.html" class="list-group-item list-group-item-action border-0">
                        ...
                        <div class="order-0 col-lg-4 col-md-6 col-sm-12 col-12 mb-3 mb-md-0 d-flex align-items-center">
                            <a class="menu-toggle-option me-3 text-primary d-flex align-items-center" href="#" title="Menu Option">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="var(--secondary-color)" class="bi bi-ui-checks-grid" viewBox="0 0 16 16">
                                ...
                                <div class="card border-0 shadow rounded-3 search-result slidedown">
                                    <div class="card-body text-start">
                                        ...
                                        <div class="dropdown-item bg-transparent text-wrap my-2">
                                            ...
                                            <a class="badge bg-primary" href="#">Tracker <i class="fa fa-search ms-1"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body p-3">
                                    <div class="row g-3">
                                        <div class="d-none d-lg-block col-lg-2 text-start">
                                            <h6 class="px-2 mb-2">Download App</h6>
                                                ...
                                                <li class="col">
                                                    <a href="ui-elements/ui-alerts.html" class="d-flex color-700">
                                                        ...
                                                        <div class="flex-fill text-truncate">
                                                            ...
                                                            <small class="text-muted">BT-5 Components</small>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li class="col">
                                                    <a href="invoices.html" class="d-flex color-700">
                                                        ...
                                                        <div class="flex-fill text-truncate">
                                                            ...
                                                            <small class="text-muted">Simple, List, Email Invoice
                                                            </small>
                                                        </div>
                                                    </a>
                                                </li>
                    ...
                    <div class="row clearfix g-3">
                        <div class="col-lg-12 col-md-12 flex-column">
                            <div class="row taskboard g-3 pb-xxl-4">
                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12 mt-xxl-4 mt-xl-4 mt-lg-4 mt-md-4 mt-sm-4 mt-4" style="margin-left: 2%">
                                    <h6 class="fw-bold py-3 mb-0">En cours</h6>
                                    <div class="progress_task">
                                        <div class="dd" data-plugin="nestable">
                                            <ol class="dd-list">
                                                <li class="dd-item" v-for="projet in projetsEnCours" :key="projet.id" draggable="true" @dragstart="onDragStart(projet)" @dragend="onDragEnd" @dragover="onDragOver" @drop="onDropEnCours">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div>{{ projet.item.name }}</div>
                                                            <div class="task-priority d-flex flex-column align-items-center justify-content-center">
                                                                <div class="avatar-list avatar-list-stacked m-0">
                                                                    <img class="avatar rounded-circle small-avt" src="../../assets/images/xs/avatar6.svg" alt="" />
                                                                    <img class="avatar rounded-circle small-avt" src="../../assets/images/xs/avatar7.svg" alt="" />
                                                                </div>
                                                                <span class="badge bg-warning text-end mt-2">{{ projet.item.statut }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
                                ...
                                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12 mt-xxl-4 mt-xl-4 mt-lg-4 mt-md-0 mt-sm-0 mt-0" style="margin-left: 10%">
                                    <h6 class="fw-bold py-3 mb-0">Terminer</h6>
                                    <div class="completed_task" @dragover="onDragOver" @drop="onDropTerminees">
                                        <div class="dd" data-plugin="nestable">
                                            <ol class="dd-list">
                                                <li class="dd-item" v-for="projet in projetsTermines" :key="projet.id" draggable="true" @dragstart="onDragStart(projet)" @dragend="onDragEnd">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div>{{ projet.item.name }}</div>
                                                            <div class="task-priority d-flex flex-column align-items-center justify-content-center">
...
export default {
  ...
  methods: {
    ...
    onDragStart(projet) {
      this.draggedProjet = projet;
    },
    onDragEnd() {
      this.draggedProjet = null;
    },
    onDragOver(event) {
      event.preventDefault();
    },
    onDropEnCours() {
      if (this.draggedProjet) {
        const index = this.projetsTermines.indexOf(this.draggedProjet);
        if (index !== -1) {
          this.projetsTermines.splice(index, 1);
          this.projetsEnCours.push(this.draggedProjet);
          this.draggedProjet.item.statut = "ENCOURS";
          this.draggedProjet = null;
        }
      }
    },
    onDropTerminees() {
      if (this.draggedProjet) {
        const index = this.projetsEnCours.indexOf(this.draggedProjet);
        if (index !== -1) {
          this.projetsEnCours.splice(index, 1);
          this.projetsTermines.push(this.draggedProjet);
          this.draggedProjet.item.statut = "TERMINER";
          this.draggedProjet = null;
        }
      }
    },
  ...
  mounted() {
    ...
    <style>
    /* Ajoutez ici les styles CSS nécessaires pour votre page */
    </style>
