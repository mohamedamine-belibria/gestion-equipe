<template>
  ...
  <div id="timetracker-layout" class="theme-mist">
    ...
    <div class="main px-lg-4 px-md-4">
            ...
            <div class="border-0 mb-4">
              ...
              >
                ...
                <div class="col-auto d-flex w-sm-100 mt-2 mt-sm-0">
                  ...
                  >
                    <i class="icofont-plus-circle me-2 fs-6"></i>Ajouter Projet
                  </router-link>
                </div>
              </div>
            </div>
      ...
      <h2 class="fw-bold text-secondary">Projets Terminés</h2>
      <table>
        ...
        <tbody>
          <tr v-for="projet in projetsTermines" :key="projet.id">
            <td class="fw-bold text-secondary">{{ projet.name }}</td>
            <td>{{ projet.description }}</td>
            <td>{{ projet.dateCreation }}</td>
            <td>{{ projet.dateFinProjet }}</td>
            <td>{{ projet.dedline }}</td>
            <td  class="badge bg-success">{{ projet.statut }}</td>
          </tr>
        </tbody>
      </table>
    </div>
