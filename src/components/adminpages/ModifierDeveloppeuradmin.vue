        ...
        <tr v-for="user in users" :key="user.id">
          ...
          <td>
            ...
            <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                      <button v-if="editingUser.id !== user.id" @click="startEditing(user)" class="icofont-edit text-success">
                                                          Modifier
                                                      </button>
                                                      ...
                                                      <router-link to="/SupprimerDeveloppeuradmin" class="btn btn-outline-secondary deleterow">
