                    ...
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            ...
                            <div class="col-auto d-flex w-sm-100 mt-2 mt-sm-0">
                                <router-link to="/AjouterProductowneradmin" class="btn btn-dark btn-set-task w-sm-100">
                                    <i class="icofont-plus-circle me-2 fs-6"></i>Ajouter Product-Owner
                                </router-link>
                            </div>
                        </div>
                    </div>
                                ...
                                <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width: 100%">
                                    ...
                                    <tbody>
                                        <tr v-for="moderator in moderators" :key="moderator.id">
                                            <td>
                                                <img class="avatar rounded-circle" src="../../assets/images/xs/avatar1.svg" alt="" />
                                                <span class="fw-bold ms-1">{{ moderator.username }}</span>
                                            </td>

                                            <td>
                                                <a href="mailto:">{{ moderator.email }}</a>
                                            </td>

                                            <td>
                                                <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                    <router-link to="/ModifierProductowneradmin" class="btn btn-outline-secondary">
