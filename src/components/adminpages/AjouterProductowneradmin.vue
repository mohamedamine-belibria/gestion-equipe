                                        ...
                                        <div class="add-product-owner">
                                            ...
                                            <form @submit.prevent="addProductOwner">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="username" v-model="productOwner.username" required class="form-control" />
                                                </div>
                                                <div class="form-group">
                                                    <label for="email">Email</label>
                                                    <input type="email" id="email" v-model="productOwner.email" required class="form-control" />
                                                </div>
                                                <div class="form-group">
                                                    <label for="password">Mot de passe</label>
                                                    <input type="password" id="password" v-model="productOwner.password" required class="form-control" />
                                                </div>
