      ...
      <div class="header">
        <nav class="navbar py-4">
          <div class="container-xxl">
                ...
                >
                  <div class="card border-0">
                    <ul class="list-unstyled py-2 px-3">
                      <li>
                        <a href="#" class=""
                          ><img src="../../assets/images/flag/GB.png" alt="" /> English</a
                        >
                      </li>
                      <li>
                        <a href="#" class=""
                          ><img src="../../assets/images/flag/DE.png" alt="" /> German</a
                        >
                      </li>
                      <li>
                        <a href="#" class=""
                          ><img src="../../assets/images/flag/FR.png" alt="" /> French</a
                        >
                      </li>
                      <li>
                        <a href="#" class=""
                          ><img src="../../assets/images/flag/IT.png" alt="" /> Italian</a
                        >
                      </li>
                      <li>
                        <a href="#" class=""
                          ><img src="../../assets/images/flag/RU.png" alt="" /> Russian</a
                        >
                      </li>
                    </ul>
                  </div>
            ...
            <!-- main menu Search-->
            <div
              class="order-0 col-lg-4 col-md-6 col-sm-12 col-12 mb-3 mb-md-0 d-flex align-items-center"
            >
              <a
                class="menu-toggle-option me-3 text-primary d-flex align-items-center"
                href="#"
                title="Menu Option"
              >
                <svg
                ...
                <div class="card border-0 shadow rounded-3 search-result slidedown">
                  <div class="card-body text-start">
                    ...
                    <div class="dropdown-item bg-transparent text-wrap my-2">
                      <a class="badge bg-primary" href="#"
                        >Pixelwibes <i class="fa fa-search ms-1"></i
                      ></a>
                      <a class="badge bg-primary" href="#"
                        >Theme <i class="fa fa-search ms-1"></i
                      ></a>
                      <a class="badge bg-primary" href="#"
                        >Tracker <i class="fa fa-search ms-1"></i
                      ></a>
                    </div>
                  </div>
                </div>
        ...
        <div class="container-xxl">
          <div class="row align-items-center">
            <div class="border-0 mb-4">
              ...
              >
                <h3 class="h4 mb-0">Ajouter un projet</h3>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <table
                    ...
                    style="width: 100%"
                  >
                  <div class="add-product-owner container-fluid">
  <div class="row">
    <div class="col-md-8 mx-auto">
      <form @submit.prevent="createProject">
        ...
        <div class="form-group">
          ...
          <input type="date" class="form-control" id="dateCreation" v-model="project.dateCreation" required>
        </div>
        <div class="form-group">
          <label for="dateFinProjet">Date de fin du projet:</label>
          <input type="date" class="form-control" id="dateFinProjet" v-model="project.dateFinProjet" required>
        </div>
        <div class="form-group">
          <label for="dedline">Date limite:</label>
          <input type="date" class="form-control" id="dedline" v-model="project.dedline" required>
        </div>
        <div class="form-group">
          <label for="statut">Statut:</label>
          <select class="form-control" id="statut" v-model="project.statut">
