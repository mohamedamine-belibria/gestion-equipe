                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            <h3 class="h4 mb-0">Liste des projets</h3>
                            <div class="col-auto d-flex w-sm-100 mt-2 mt-sm-0">
                                <router-link to="/AjouterProjetadmin" class="btn btn-dark btn-set-task w-sm-100">
                                    <i class="icofont-plus-circle me-2 fs-6"></i>Ajouter un Projet
                                </router-link>
                            </div>
                        </div>
                    </div>
                                                                ...
                                                                <div class="card-body">
                                                                    <div class="d-flex align-items-center justify-content-between mt-5">
                                                                        ...
                                                                        <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                                            ...
                                                                            <button type="button" class="btn btn-outline-secondary" @click="navigateToAffectationAdmin">
                                                                    ...
                                                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                                                        <h4 class="small fw-bold mb-0">{{ projet.statut }}</h4>
                                                                        <span class="small light-danger-bg p-1 rounded">
                                                                            <i class="icofont-ui-clock"></i> {{ projet.dateFinProjet }}
                                                                        </span>
                                                                    </div>
                                                                </div>
                                                            </div>
