<template>
        ...
        <div class="container-xxl">
          <div class="row align-items-center">
            <div class="border-0 mb-4">
              ...
              >
                <h3 class="h4 mb-0">List Product-Owner</h3>
                <div class="col-auto d-flex w-sm-100 mt-2 mt-sm-0">
                  <router-link
                    to="/AjouterDevloppeurpo"
  ...
  <button @click="confirmDeleteModerator(moderator.id)" class="btn btn-danger">
      Supprimer
  </button>
</div>
            </td>
