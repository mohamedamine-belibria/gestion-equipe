            ...
            <ul class="menu-list flex-grow-1 mt-3">
                ...
                <li class="collapsed">
                    ...
                    <ul class="sub-menu collapse" id="menu-order">
                        <li>
                            <router-link class="ms-link" to="/ListeDeProjetsmod">Liste De Mes Projets
                            </router-link>
                        </li>
                        <li>
                                            ...
                                            <ul class="list-unstyled list mb-0">
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="../dist/../../assets/images/xs/avatar1.svg" alt="" />
                                                ...
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="../dist/../../assets/images/xs/avatar3.svg" alt="" />
                                                        <div class="flex-fill ms-2">
                                                            <p class="d-flex justify-content-between mb-0">
                                                ...
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="../dist/../../assets/images/xs/avatar5.svg" alt="" />
                                                        <div class="flex-fill ms-2">
                                                            <p class="d-flex justify-content-between mb-0">
                                                ...
                                                <li class="py-2 mb-1 border-bottom">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="../dist/../../assets/images/xs/avatar6.svg" alt="" />
                                                        <div class="flex-fill ms-2">
                                                            <p class="d-flex justify-content-between mb-0">
                                                ...
                                                <li class="py-2">
                                                    <a href="javascript:void(0);" class="d-flex">
                                                        <img class="avatar rounded-circle" src="../dist/../../assets/images/xs/avatar7.svg" alt="" />
                                                        <div class="flex-fill ms-2">
                                                            <p class="d-flex justify-content-between mb-0">
                            ...
                            <div class="card-body p-3">
                                <div class="row g-3">
                                    <div class="d-none d-lg-block col-lg-2 text-start">
                                        ...
                                        <img src="../dist/../../assets/images/qr-code.png" alt="Download App" class="img-fluid" />
                                    </div>
                                    <div class="col-lg-10">
            ...
            <div class="container-xxl">
                <div class="card">
                    <div class="card-header bg-transparent">
                        <h3 class="card-title mb-0">Créer une tâche</h3>
                    </div>
                    <div class="card-body">
                        <form @submit.prevent="createProject">
                            <div class="row mb-3">
                                <label for="name" class="col-sm-3 col-form-label">Nom du TACHE:</label>
                                <div class="col-sm-9">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <textarea id="description" class="form-control" v-model="project.description" required></textarea>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="dateCreation" class="col-sm-3 col-form-label">Date de création:</label>
                                <div class="col-sm-9">
                                    <input type="date" id="dateCreation" class="form-control" v-model="project.dateCreation" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="dateFinProjet" class="col-sm-3 col-form-label">Date de fin du projet:</label>
                                <div class="col-sm-9">
                                    <input type="date" id="dateFinProjet" class="form-control" v-model="project.dateFinProjet" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="dedline" class="col-sm-3 col-form-label">Date limite:</label>
                                <div class="col-sm-9">
                                    <input type="date" id="dedline" class="form-control" v-model="project.dedline" required />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <label for="statut" class="col-sm-3 col-form-label">Statut:</label>
                                <div class="col-sm-9">
                                    <select id="statut" class="form-select" v-model="project.statut">
