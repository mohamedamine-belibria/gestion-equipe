        ...
        <div class="body d-flex py-lg-3 py-md-2">
            <div class="container-xxl">
                ...
                <div class="projects-page">
                    <h2 class="fw-bold text-secondary">les projets terminées</h2>
                    <table class="table">
