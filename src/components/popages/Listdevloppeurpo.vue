                ...
                >
                  <div class="card border-0">
                    <ul class="list-unstyled py-2 px-3">
                      ...
                      <li>
                        <a href="#" class=""
                          ><img src="../dist/../../assets/images/flag/DE.png" alt="" />
                          German</a
                        >
                      </li>
                      <li>
                        <a href="#" class=""
                          ><img src="../dist/../../assets/images/flag/FR.png" alt="" />
                          French</a
                        >
                      </li>
                      <li>
                        <a href="#" class=""
                          ><img src="../dist/../../assets/images/flag/IT.png" alt="" />
                          Italian</a
                        >
                      </li>
                      <li>
                        <a href="#" class=""
                          ><img src="../dist/../../assets/images/flag/RU.png" alt="" />
                          Russian</a
                        >
                      </li>
                    </ul>
            ...
            <div class="modal-body custom_setting">
              ...
              <div class="setting-theme pb-3">
                <h6 class="card-title mb-2 fs-6 d-flex align-items-center">
                  <i class="icofont-color-bucket fs-4 me-2 text-primary"></i>Template
                  Color Settings
                </h6>
                <ul class="list-unstyled row row-cols-3 g-2 choose-skin mb-2 mt-2">
                  ...
                  <li data-theme="mist" class="active">
                    <div class="mist"></div>
                  </li>
                  <li data-theme="cyan">
                    <div class="cyan"></div>
              ...
              <div class="dynamic-block py-3">
                <ul class="list-unstyled choose-skin mb-2 mt-1">
                  <li data-theme="dynamic">
                    <div class="dynamic">
                      <i class="icofont-paint me-2"></i> Click to Dyanmic Setting
                    </div>
                  </li>
                </ul>
              ...
              <div class="setting-font py-3">
                <h6 class="card-title mb-2 fs-6 d-flex align-items-center">
                  <i class="icofont-font fs-4 me-2 text-primary"></i> Font Settings
                </h6>
                ...
                <ul class="list-group list-unstyled mb-0 mt-1">
                  ...
                  <li class="list-group-item d-flex align-items-center py-1 px-2">
                    <div class="form-check form-switch theme-high-contrast mb-0">
                      ...
                      />
                      <label class="form-check-label" for="theme-high-contrast"
