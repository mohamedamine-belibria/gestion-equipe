            ...
            <div class="container-xxl">
                ...
                <div class="row clearfix g-3">
                    <div class="col-sm-12">
                        <div class="card mb-3">
                            <div class="card-body">
                                <h2 class="card-title">Tache Assignment</h2>
                                <div class="form-container">
                                    <div class="form-group">
                                        <label for="selectedTache">Select Project:</label>
                                        <select v-model="selectedTache" id="selectedTache" class="form-control">
                                            <option v-for="tache in taches" :value="tache.item.id" :key="tache.item.id">{{ tache.item.name }}</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="selectedProjet">Select Tache:</label>
                                        <select v-model="selectedProjet" id="selectedProjet" class="form-control">
                                            <option v-for="projet in projets" :value="projet.item.id" :key="projet.item.id">{{ projet.item.name }}</option>
                                        </select>
                                    </div>
                                    <div class="text-center">
                                        <button @click="affecter" class="btn btn-primary">Assign Project</button>
                                    </div>
                                </div>
                            </div>
                        </div>
