                            ...
                            <div class="card-body">
                                <div class="form-container">
                                    ...
                                    <select v-model="selectedProjet" id="selectedProjet" class="form-control">
                                        <option v-for="projet in projets" :value="projet.id" :key="projet.id">{{ projet.name }}</option>
                                    </select>

                                    <label for="selectedModerateur">Select devlopeur:</label>
                                    <select v-model="selectedModerateur" id="selectedModerateur" class="form-control">
                                        <option v-for="moderateur in moderateurs" :value="moderateur.id" :key="moderateur.id">{{ moderateur.username }}</option>
                                    </select>
