                                    ...
                                    <table id="myProjectTable" class="table table-hover align-middle mb-0" style="width: 100%">
                                        ...
                                        <tbody>
                                            <tr v-for="user in users" :key="user.id">
                                                <td>
                                                    <img class="avatar rounded-circle" src="../../assets/images/xs/avatar1.svg" alt="" />
                                                    <span class="fw-bold ms-1" v-if="editingUser.id !== user.id">{{ user.username }}</span>
                                                    <input v-else v-model="editingUser.username" />
                                                </td>
                                                <td>
                                                    <a href="mailto:" v-if="editingUser.id !== user.id">{{
                              user.email
                            }}</a>
                                                    <input v-else v-model="editingUser.email" />
                                                </td>
                                                <td>
                                                    <div class="btn-group" role="group" aria-label="Basic outlined example">
                                                        ...
                                                        <router-link to="/SupprimerDeveloppeurpo" class="btn btn-outline-secondary deleterow">
