                    ...
                    <div class="row align-items-center">
                        <div class="border-0 mb-4">
                            <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                                <h3 class="h4 mb-0">Affectation de tâches</h3>
                                ...
                                <div class="card-body">
                                    <div class="form-container">
                                        <div class="form-group">
                                            <label for="selectedProjet">Sélectionnez une tâche :</label>
                                        ...
                                        <div class="form-group">
                                            <label for="selectedModerateur">Sélectionnez un développeur :</label>
                                        ...
                                        <div class="text-center">
                                            <button @click="affecter" class="btn btn-primary">
                                                Assigner le projet
                                            </button>
                                        </div>
                                    </div>
