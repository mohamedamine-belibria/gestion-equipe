    ...
    <div class="col-md-9">
      <div class="home-page">
        <div class="welcome-section">
          ...
          <p>
            Nous sommes une société qui applique la méthode Agile pour la gestion de projets et des tâches. Notre objectif est de vous fournir un outil efficace pour la gestion de vos projets et la collaboration entre les membres de votre équipe.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>Ajouter, modifier et supprimer des product owners</li>
            <li>Ajouter, modifier et supprimer des projets</li>
            <li>Affecter des projets à des product owners</li>
            <li>Visualiser les statistiques des projets</li>
          </ul>
        </div>
        <div class="statistics-section">
          <!-- Ajoutez ici la section des statistiques des projets -->
        </div>
      </div>
    </div>
  </div>
