...
<div class="row">
    ...
    <div class="col-md-3">
        ...
        <div class="sidebar px-4 py-4 py-md-5 me-0 open" style="margin-left: -150px; margin-bottom: -20px; height: 98%;">
                ...
                <ul class="menu-list flex-grow-1 mt-3">
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="form">
                            ...
                            <li>
                                <router-link class="ms-link" to="/listedemestache">Mes tache</router-link>
                            </li>
                    ...
                    <li class="collapsed">
                        ...
                        <ul class="sub-menu collapse" id="font">
                            <li>
                                <router-link class="ms-link" to="/tacheEncouruser">Tache En Cours</router-link>
                            </li>
                            <li>
                                <router-link class="ms-link" to="/tachetermineruser">Tache Termine</router-link>
                            </li>
                            ...
                            <div class="card-body">
                                <div class="row g-3">
                                    <div class="col-md-12 col-lg-3">
                                        <img src="../assets/images/dev.jpg" class="img-thumbnail" alt="..." style="width: 260px" />
                                        <ul class="list-unstyled custom d-flex mb-3 mt-3">
                                            <li class="me-3">
                                                <a href="#" class="card-link"><i class="fa fa-lg fa-facebook"></i></a>
                                            </li>
                                            <li class="me-3">
                                                <a href="#" class="card-link"><i class="fa fa-lg fa-twitter"></i></a>
                                            </li>
                                            <li class="me-3">
                                                <a href="#" class="card-link"><i class="fa fa-lg fa-instagram"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                ...
                <div class="row g-3">
                    <div class="col-12">
                        <ul class="nav nav-tabs tab-body-header rounded d-inline-flex">
                            <li class="nav-item">
                                <a class="nav-link show active" data-bs-toggle="tab" href="#Company_Settings">Company</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#Notifications">Notifications
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#Change_Password">Change Password
                                </a>
                            </li>
                        </ul>
